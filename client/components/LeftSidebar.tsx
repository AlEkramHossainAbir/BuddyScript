...
const suggestedPeople = [
  { name: 'Steve Jobs', title: 'CEO of Apple', image: 'assets/images/people1.png', imageClass: '_info_img' },
  { name: 'Ryan Roslansky', title: 'CEO of Linkedin', image: 'assets/images/people2.png', imageClass: '_info_img1' },
  { name: 'Dylan Field', title: 'CEO of Figma', image: 'assets/images/people3.png', imageClass: '_info_img1' },
];

const events = [
  { day: '10', month: 'Jul', title: 'No more terrorism no more cry', peopleGoing: '17 People Going', image: 'assets/images/feed_event1.png' },
  { day: '10', month: 'Jul', title: 'No more terrorism no more cry', peopleGoing: '17 People Going', image: 'assets/images/feed_event1.png' },
];
      ...
      <div className="_layout_left_sidebar_inner">
        <div className="_left_inner_area_event _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          ...
          {events.map((event, index) => (
            <a key={index} className="_left_inner_event_card_link" href="event-single.html">
              <div className="_left_inner_event_card">
                ...
                <div className="_left_inner_event_bottom">
                  <p className="_left_iner_event_bottom">{event.peopleGoing}</p>{" "}
