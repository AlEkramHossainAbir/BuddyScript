          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            <li className="nav-item _header_nav_item">
              ...
              >
                ...
                <div id="_notify_drop" className={`_notification_dropdown ${showNotificationDropdown ? 'show' : ''}`}>
                  <div className="_notifications_content">
                    <h4 className="_notifications_content_title">Notifications</h4>
                  </div>
                  <div className="_notifications_drop_box">
                    <div className="_notifications_drop_btn_grp">
                      <button className="_notifications_btn_link">All Notifications</button>
                      <button className="_notifications_btn_link1">Mentions</button>
                    </div>
                    <div className="_notifications_all">
                      <p style={{ padding: '20px', textAlign: 'center' }}>No notifications yet</p>
                    </div>
                  </div>
                </div>
              </span>
              ...
              <ul className="_nav_dropdown_list">
                <li className="_nav_dropdown_list_item">
                  <button 
                    ...
                    style={{ border: 'none', background: 'none', width: '100%', textAlign: 'left', cursor: 'pointer', padding: '10px 15px' }}
                  >
